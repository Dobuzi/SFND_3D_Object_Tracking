...
int main(int argc, const char *argv[])
{
    ...
    bool bVis = args["--bVis"].compare("true") == 0 ? true : false;            // visualize results
    ...
    for (size_t imgIndex = 0; imgIndex <= imgEndIndex - imgStartIndex; imgIndex+=imgStepWidth)
    {
        ...
        bool bVis3D = args["--bVis3D"].compare("true") == 0 ? true : false;
        if(bVis3D)
        {
        ...
        string detectorType = args["--detector"];
        bool bVisDetector = args["--bVisDetector"].compare("true") == 0 ? true : false;
        ...
        bool bLimitKpts = args["--bLimitKpts"].compare("true") == 0 ? true : false;;
        if (bLimitKpts)
        {
            int maxKeypoints = 50;
